...
public class ThermalEndergyBlocks {
	...
	public static final TagKey<Item> PRISMALIUM_ITEM_TAG = TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation("forge", "storage_blocks/prismalium"));
	public static final TagKey<Block> PRISMALIUM_BLOCK_TAG = TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation("forge", "storage_blocks/prismalium"));
	private static final TagKey<Item> PRISMALIUM_INGOT = TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation("forge", "ingots/prismalium"));
	...
	public static final TagKey<Item> MELODIUM_ITEM_TAG = TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation("forge", "storage_blocks/melodium"));
	public static final TagKey<Block> MELODIUM_BLOCK_TAG = TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation("forge", "storage_blocks/melodium"));
	private static final TagKey<Item> MELODIUM_INGOT = TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation("forge", "ingots/melodium"));
	...
	public static final TagKey<Item> STELLARIUM_ITEM_TAG = TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation("forge", "storage_blocks/stellarium"));
	public static final TagKey<Block> STELLARIUM_BLOCK_TAG = TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation("forge", "storage_blocks/stellarium"));
	private static final TagKey<Item> STELLARIUM_INGOT = TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation("forge", "ingots/stellarium"));
